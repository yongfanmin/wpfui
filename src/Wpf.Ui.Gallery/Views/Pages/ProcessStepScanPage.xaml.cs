...
public partial class ProcessStepScanPage : INavigableView<ProcessStepScanViewModel>
{
    public ProcessStepScanViewModel ViewModel { get; }

    public ProcessStepScanPage(ProcessStepScanViewModel viewModel)
    {
        ViewModel = viewModel;
        DataContext = this;
